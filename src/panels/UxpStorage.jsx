...
import { GenerateAILayer, GetImageProcessingProgress, Img2Img } from '../utils/ai_service';
		...
		<>
			<sp-button
				onClick={async () => {
					...
					SetBase64MergedImgStr((await GetDataFolderImageBase64ImgStr(MERGEDFILENAME)).base64Data)
				}}
			>
				Merge Layers
			</sp-button>
			<ProgressButton
				...
				longRunningFunction={() => GenerateAILayer(base64MergedImgStr, 512, 512, "Colorful illustrated anime knifes sloped to the right in the illustration")}
