...
export async function generateImageLayerUsingOnlyContext(
	...
	try {
		...
		if (genb64Str) {
			...
			// stack.
			let generatedFileName = await layerContext.createTempGenFile(genb64Str);
...
export async function generateImageLayerUsingLayer(
	...
	try {
		...
		let tempFileEntry = await layerContext.createTempFile()
		...
		if (genb64Str) {
			...
			let generatedFileName =
				await layerContext.createTempGenFile(genb64Str);
